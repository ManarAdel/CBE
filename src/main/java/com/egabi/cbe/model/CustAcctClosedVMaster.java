...
/**
 * The persistent class for the CUST_ACCT_CLOSED_V_MASTER database table.
 * 
 */
@Entity
@Table(name="CUST_ACCT_CLOSED_V_MASTER")
@NamedQuery(name="CustAcctClosedVMaster.findAll", query="SELECT c FROM CustAcctClosedVMaster c")
public class CustAcctClosedVMaster implements Serializable {
