...
/**
 * The persistent class for the CORPORATE_LIMITS_V database table.
 * 
 */
@Entity
@Table(name="CORPORATE_LIMITS_V")
@NamedQuery(name="CorporateLimitsV.findAll", query="SELECT c FROM CorporateLimitsV c")
public class CorporateLimitsV implements Serializable {
