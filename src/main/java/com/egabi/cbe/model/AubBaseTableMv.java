...
/**
 * The persistent class for the AUB_BASE_TABLE_MV database table.
 * 
 */
@Entity
@Table(name="AUB_BASE_TABLE_MV")
@NamedQuery(name="AubBaseTableMv.findAll", query="SELECT a FROM AubBaseTableMv a")
public class AubBaseTableMv implements Serializable {
