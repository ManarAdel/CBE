...
/**
 * The persistent class for the CBR_REP_PARAM_SELECT database table.
 * 
 */
@Entity
@Table(name="CBR_REP_PARAM_SELECT")
@NamedQuery(name="CbrRepParamSelect.findAll", query="SELECT c FROM CbrRepParamSelect c")
public class CbrRepParamSelect implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private CbrRepParamSelectPK id;
	...
	public CbrRepParamSelect() {
	}

	public CbrRepParamSelectPK getId() {
		return this.id;
	}

	public void setId(CbrRepParamSelectPK id) {
		this.id = id;
	}
