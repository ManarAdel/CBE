...
/**
 * The persistent class for the FAUDIT_HIST database table.
 * 
 */
@Entity
@Table(name="FAUDIT_HIST")
@NamedQuery(name="FauditHist.findAll", query="SELECT f FROM FauditHist f")
public class FauditHist implements Serializable {
