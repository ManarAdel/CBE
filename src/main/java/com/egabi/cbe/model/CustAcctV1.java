...
/**
 * The persistent class for the CUST_ACCT_V1 database table.
 * 
 */
@Entity
@Table(name="CUST_ACCT_V1")
@NamedQuery(name="CustAcctV1.findAll", query="SELECT c FROM CustAcctV1 c")
public class CustAcctV1 implements Serializable {
