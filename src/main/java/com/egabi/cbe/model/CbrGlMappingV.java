...
/**
 * The persistent class for the CBR_GL_MAPPING_V database table.
 * 
 */
@Entity
@Table(name="CBR_GL_MAPPING_V")
@NamedQuery(name="CbrGlMappingV.findAll", query="SELECT c FROM CbrGlMappingV c")
public class CbrGlMappingV implements Serializable {
