...
/**
 * The primary key class for the CBR_REP_PARAM_SELECT_HIST database table.
 * 
 */
@Embeddable
public class CbrRepParamSelectHistPK implements Serializable {
	...
	public CbrRepParamSelectHistPK() {
	}
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof CbrRepParamSelectHistPK)) {
			return false;
		}
		CbrRepParamSelectHistPK castOther = (CbrRepParamSelectHistPK)other;
		return 
