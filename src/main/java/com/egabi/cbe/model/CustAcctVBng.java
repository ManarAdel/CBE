...
/**
 * The persistent class for the CUST_ACCT_V_BNG database table.
 * 
 */
@Entity
@Table(name="CUST_ACCT_V_BNG")
@NamedQuery(name="CustAcctVBng.findAll", query="SELECT c FROM CustAcctVBng c")
public class CustAcctVBng implements Serializable {
