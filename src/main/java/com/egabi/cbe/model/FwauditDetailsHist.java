...
/**
 * The persistent class for the FWAUDIT_DETAILS_HIST database table.
 * 
 */
@Entity
@Table(name="FWAUDIT_DETAILS_HIST")
@NamedQuery(name="FwauditDetailsHist.findAll", query="SELECT f FROM FwauditDetailsHist f")
public class FwauditDetailsHist implements Serializable {
