...
/**
 * The persistent class for the AUB_BASE_TABLE_OLD database table.
 * 
 */
@Entity
@Table(name="AUB_BASE_TABLE_OLD")
@NamedQuery(name="AubBaseTableOld.findAll", query="SELECT a FROM AubBaseTableOld a")
public class AubBaseTableOld implements Serializable {
