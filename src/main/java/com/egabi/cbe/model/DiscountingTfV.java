...
/**
 * The persistent class for the DISCOUNTING_TF_V database table.
 * 
 */
@Entity
@Table(name="DISCOUNTING_TF_V")
@NamedQuery(name="DiscountingTfV.findAll", query="SELECT d FROM DiscountingTfV d")
public class DiscountingTfV implements Serializable {
