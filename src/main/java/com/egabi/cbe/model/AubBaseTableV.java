...
/**
 * The persistent class for the AUB_BASE_TABLE_V database table.
 * 
 */
@Entity
@Table(name="AUB_BASE_TABLE_V")
@NamedQuery(name="AubBaseTableV.findAll", query="SELECT a FROM AubBaseTableV a")
public class AubBaseTableV implements Serializable {
