...
/**
 * The persistent class for the CBR_GL_MAPPING_V_MASTER database table.
 * 
 */
@Entity
@Table(name="CBR_GL_MAPPING_V_MASTER")
@NamedQuery(name="CbrGlMappingVMaster.findAll", query="SELECT c FROM CbrGlMappingVMaster c")
public class CbrGlMappingVMaster implements Serializable {
