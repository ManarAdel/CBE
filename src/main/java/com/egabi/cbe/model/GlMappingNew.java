...
/**
 * The persistent class for the GL_MAPPING_NEW database table.
 * 
 */
@Entity
@Table(name="GL_MAPPING_NEW")
@NamedQuery(name="GlMappingNew.findAll", query="SELECT g FROM GlMappingNew g")
