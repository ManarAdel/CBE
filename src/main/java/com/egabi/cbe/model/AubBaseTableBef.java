...
/**
 * The persistent class for the AUB_BASE_TABLE_BEF database table.
 * 
 */
@Entity
@Table(name="AUB_BASE_TABLE_BEF")
@NamedQuery(name="AubBaseTableBef.findAll", query="SELECT a FROM AubBaseTableBef a")
public class AubBaseTableBef implements Serializable {
