...
/**
 * The persistent class for the AUB_BASE_TABLE_TABLE database table.
 * 
 */
@Entity
@Table(name="AUB_BASE_TABLE_TABLE")
@NamedQuery(name="AubBaseTableTable.findAll", query="SELECT a FROM AubBaseTableTable a")
public class AubBaseTableTable implements Serializable {
