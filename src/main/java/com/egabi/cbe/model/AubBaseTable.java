...
/**
 * The persistent class for the AUB_BASE_TABLE database table.
 * 
 */
@Entity
@Table(name="AUB_BASE_TABLE")
@NamedQuery(name="AubBaseTable.findAll", query="SELECT a FROM AubBaseTable a")
public class AubBaseTable implements Serializable {
