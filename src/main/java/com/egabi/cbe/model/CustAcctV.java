...
/**
 * The persistent class for the CUST_ACCT_V database table.
 * 
 */
@Entity
@Table(name="CUST_ACCT_V")
@NamedQuery(name="CustAcctV.findAll", query="SELECT c FROM CustAcctV c")
public class CustAcctV implements Serializable {
